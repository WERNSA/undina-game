...
func _on_BtnLog_pressed():
	...
	$LblDialog.text = "¡Hola " + player_name + """! Soy Ilea, gracias por unirte a la misión de salvar los océanos, juntos(as)\n lograremos que los océanos de la región de Cabia vuelvan a ser como antes."""
